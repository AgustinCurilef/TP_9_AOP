...
public class VentanaInscripcionRadioCompetition {
    ...
    public VentanaInscripcionRadioCompetition(SistemaRadioCompetition sistemaRadioCompetition) {
        this.sistemaRadioCompetition = sistemaRadioCompetition;
                                ...
                                .createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
                                        ...
                                        .addGroup(
                                                gl_contentPane.createParallelGroup(Alignment.LEADING, false)
                                                        .addComponent(comboBoxConcursos, 0, GroupLayout.DEFAULT_SIZE,
                                                                Short.MAX_VALUE)
                                        ...
                                        .addGroup(gl_contentPane.createSequentialGroup()
                                                ...
                                                .addPreferredGap(ComponentPlacement.RELATED).addGroup(
                                                        gl_contentPane.createParallelGroup(Alignment.BASELINE)
                                                                .addComponent(comboBoxConcursos, GroupLayout.PREFERRED_SIZE,
                                                                        GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
